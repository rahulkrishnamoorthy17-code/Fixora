(function () {
  ...
  var NAV = [
    { label: "Home", icon: "bi-house-door", children: [
      { file: "index.html", label: "Home – General Repair", icon: "bi-house-door" },
      { file: "home-2.html", label: "Home – Premium Services", icon: "bi-stars" }
    ]},
  ...
  function headerHtml() {
    ...
    return '<div class="topbar d-none d-lg-block"><div class="container d-flex align-items-center justify-content-between"><div><span><i class="bi bi-telephone-fill me-2" style="color:#00d4ff"></i>+1 (800) 555-0199</span><span class="divider-dot">|</span><span class="hide-sm"><i class="bi bi-envelope-fill me-2" style="color:#00d4ff"></i>help@fixora.com</span></div><div><span><i class="bi bi-clock-fill me-2" style="color:#00d4ff"></i>Mon–Sat: 8AM–9PM</span></div></div></div>' +
      '<nav class="navbar navbar-expand-xxl navbar-fixora sticky-top" id="mainNav"><div class="container d-flex flex-nowrap align-items-center justify-content-between"><a class="navbar-brand me-0" href="index.html"><span class="brand-mark"><i class="bi bi-wrench-adjustable"></i></span><span class="d-none d-sm-inline-block ms-2">Fixora</span></a><div class="d-flex flex-nowrap align-items-center gap-1 gap-sm-2 order-xxl-3"><button class="btn-icon" id="themeToggle" type="button" aria-label="Toggle theme" title="Light / Dark mode"><i class="bi bi-moon-stars"></i></button><button class="btn-icon direction-toggle" id="rtlToggle" type="button" aria-label="Switch text direction" title="Switch RTL/LTR"><i class="bi bi-text-right direction-icon"></i><span id="rtlLabel" class="d-none d-sm-inline-block">RTL</span></button>' + authDesktop(user) + '<button class="btn-icon d-xxl-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#mobileMenu" aria-label="Open menu"><i class="bi bi-list fs-5"></i></button></div><div class="collapse navbar-collapse order-xxl-2 justify-content-center d-none d-xxl-flex"><ul class="navbar-nav gap-1">' + navLinksHtml() + '</ul></div></div></nav>' +
